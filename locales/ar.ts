export const ar = {
  ...
  about: {
    ...
    paragraph4: 'لقد وضعنا لك اجمل نسختين ذهبية و فضية لما يتناسب مع ذوقك واهتمامك. فهذا الكتاب يعتبر دليل أنيق للعناية الذاتية والثقة والجاذبية.',
  },
  ...
  features: {
    ...
    items: [
      ...
      { icon: 'mail', title: 'إرسال فوري على إيميلك', desc: 'بمجرد الدفع، يصل كتابك إلى بريدك الإلكتروني خلال لحظات' },
      { icon: 'phone', title: 'اقرئي على أي جهاز', desc: 'PDF متوافق مع الهاتف، التابلت، والكمبيوتر' },
    ],
  },

  purchase: {
    sectionTitle: 'اختاري نسختك المفضلة',
    subtitle: 'بما يناسب ذوقك',
    editionSelector: 'اختاري النسخة المناسبة لكِ',
    standardEdition: 'النسخة الفضية',
  ...
  footer: {
    ...
    copyright: '© 2026 نورة محمد النجار. جميع الحقوق محفوظة.',
    contact: 'تواصلي معنا',
  ...
  thankYou: {
    ...
    message: 'سيصل كتابك الشخصي إلى بريدك الإلكتروني خلال لحظات. تحققي من صندوق الوارد (وأيضاً مجلد الرسائل غير المرغوبة).',
